...
# Data bag user object needs an "action": "remove" tag to actually be
...
# :group_name is the string name of the group to create, defaults to
#   resource name
# :group_id is the numeric id of the group to create
# :cookbook is the name of the cookbook that the authorized_keys template
#   should be found in
